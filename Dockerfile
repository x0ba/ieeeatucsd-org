...
ENV PUBLIC_GOOGLE_CALENDAR_ID=$PUBLIC_GOOGLE_CALENDAR_ID
...
ENV AUTH_BRIDGE_MODE=$AUTH_BRIDGE_MODE
ENV VITE_AUTH_BRIDGE_MODE=$VITE_AUTH_BRIDGE_MODE
...
ENV CONVEX_SESSION_SECRET=$CONVEX_SESSION_SECRET
...
ENV CONVEX_SELF_HOSTED_URL=${CONVEX_SELF_HOSTED_URL:-}
ENV CONVEX_SELF_HOSTED_ADMIN_KEY=${CONVEX_SELF_HOSTED_ADMIN_KEY:-}
ENV AUTH_BRIDGE_MODE=${AUTH_BRIDGE_MODE:-legacy}
ENV VITE_AUTH_BRIDGE_MODE=${VITE_AUTH_BRIDGE_MODE:-legacy}
ENV LOGTO_ENDPOINT=${LOGTO_ENDPOINT:-}
ENV LOGTO_APP_ID=${LOGTO_APP_ID:-}
ENV LOGTO_M2M_APP_ID=${LOGTO_M2M_APP_ID:-}
ENV LOGTO_M2M_APP_SECRET=${LOGTO_M2M_APP_SECRET:-}
