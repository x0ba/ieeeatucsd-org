...
/**
 * Allowed file extensions for reimbursement receipt uploads
 */
const ALLOWED_EXTENSIONS = ["png", "jpg", "jpeg", "heic", "pdf"] as const;
...
/**
 * POST /api/validate-receipt-files
 * 
 * Validates file information for reimbursement receipt uploads before uploading to Firebase Storage.
...
export const POST: APIRoute = async ({ request, cookies }) => {
  try {
    ...
    console.error("Error validating receipt files:", error);
