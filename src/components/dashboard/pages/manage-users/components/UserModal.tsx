...
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Input, Select, SelectItem, Spacer } from '@heroui/react';
                ...
                {(onModalClose) => (
                    <>
                        ...
                        <ModalBody className="overflow-x-hidden">
                            <form onSubmit={handleSubmit} className="space-y-8 max-w-full" id="user-form">
                                ...
                                {canEditPoints && (
                                    <div className="space-y-5 pt-6 border-t border-gray-100">
                                        <div>
                                            <h3 className="text-sm font-semibold text-gray-900 mb-4">Points Management</h3>
                                            <Input
                                                type="number"
                                                label="Points"
                                                labelPlacement="outside"
