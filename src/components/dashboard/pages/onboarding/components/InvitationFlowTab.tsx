...
import { Card, CardBody, Input, Select, SelectItem, Textarea, Button, Spacer } from '@heroui/react';
...
export default function InvitationFlowTab({ onSendInvitation, loading }: InvitationFlowTabProps) {
        ...
        <div className="max-w-4xl">
            <Card>
                <CardBody className="p-6">
                    <div className="mb-6">
                        <h3 className="text-lg font-semibold text-gray-900">Send Officer Invitation</h3>
                        <p className="text-sm text-gray-500 mt-1">
                            Send an invitation email asking the prospective officer to accept their position.
                            Upon acceptance, they will be automatically onboarded.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <Input
                                ...
                                classNames={{
                                    inputWrapper: "rounded-lg",
                                    label: "!transform-none !text-xs !top-2 !left-3 !text-default-600"
                                }}
                            />
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <ul className="text-sm text-blue-700 space-y-1 list-disc list-inside">
                                ...
                                <li>They will have until the acceptance deadline to accept or decline the position</li>
