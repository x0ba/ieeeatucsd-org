...
export default function ReceiptForm({
    ...
    const calculateTotals = () => {
        ...
        const total = subtotal + (receipt.tax || 0) + (receipt.tip || 0) + (receipt.shipping || 0);
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                {isParsing && (
                    <div className="mb-3 bg-blue-50 border border-blue-200 rounded-lg p-3 flex items-center space-x-3">
                        ...
                        <div>
                            <p className="text-sm font-medium text-blue-900">Parsing receipt with AI...</p>
                ...
                {parseResult && !isParsing && (
                    <div className={`mb-3 rounded-lg p-3 flex items-start space-x-3 ${parseResult.success
                        ...
                        <div>
                            <p className={`text-sm font-medium ${parseResult.success ? 'text-green-900' : 'text-yellow-900'
                                }`}>
                                {parseResult.message}
                            </p>
                        </div>
                ...
                {/* Upload Area */}
                <div
                    className={`border-2 border-dashed rounded-lg transition-colors ${receipt.receiptFile
                ...
                >
                    {isUploading ? (
                        ...
                        <div className="h-32 flex items-center justify-center">
                            <div className="text-center">
                                <Upload className="mx-auto h-8 w-8 text-gray-400 mb-2" aria-hidden="true" />
            ...
            {isParsing ? (
                <div className="text-center py-12 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <p className="text-lg font-semibold text-blue-900 mb-2">AI is analyzing your receipt...</p>
                    <p className="text-sm text-blue-700">This usually takes 2-5 seconds. Please wait.</p>
                </div>
            ) : (
                <>
                    {/* Receipt Header Info */}
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
                                            ...
                                            <div className="md:col-span-3">
                                                <Input
                                                    ...
                                                    placeholder="0.00"
                                                    startContent={<DollarSign className="w-3 h-3 text-gray-400" aria-hidden="true" />}
                                                    size="sm"
