    ...
    `;
        ...
        await resend.emails.send({
          ...
          <div style="margin-top:24px;text-align:center">
            <a href="https://ieeeatucsd.org/manage-fund-requests" style="background:#003B5C;color:white;padding:12px 24px;text-decoration:none;border-radius:6px;font-weight:500;display:inline-block">Review Request</a>
          </div>
        `,
                fundRequest.id,
            ),
        ...
        if (user.email) {
            ...
            <div style="margin-top:24px;text-align:center">
              <a href="https://ieeeatucsd.org/fund-requests" style="background:#3b82f6;color:white;padding:12px 24px;text-decoration:none;border-radius:6px;font-weight:500;display:inline-block">View Your Request</a>
            </div>
          `,
                    fundRequest.id,
                ),
...
export async function sendFundRequestStatusChangeEmail(
    ...
    try {
        ...
        `;
          ...
          <div style="margin-top:24px;text-align:center">
            <a href="https://ieeeatucsd.org/fund-requests" style="background:#d97706;color:white;padding:12px 24px;text-decoration:none;border-radius:6px;font-weight:500;display:inline-block">Update Your Request</a>
          </div>
        `;
                break;
