  ...
  if (compact) {
    return (
      <div className="text-sm space-y-1 mt-2">
        ...
        <div className="flex justify-between font-semibold text-gray-900 dark:text-gray-100 pt-1 border-t">
          <span>Recommended Budget:</span>
          <span>
            ${recommendedBudget.toLocaleString()}
            {maxReached && (
              <span className="text-amber-600 dark:text-amber-400 text-xs font-normal ml-1">
  ...
  return (
    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mt-3">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h4 className="text-sm font-semibold text-blue-800 dark:text-blue-200">Budget Calculation</h4>
      </div>
      <div className="space-y-2 text-sm">
        ...
        <div className="flex justify-between font-bold text-blue-900 dark:text-blue-100 pt-2 border-t border-blue-200 dark:border-blue-700">
          <span>Recommended Budget:</span>
          <span>
            ${recommendedBudget.toLocaleString()}
            {maxReached && (
      ...
      {maxReached && (
        <div className="flex items-start gap-2 mt-3 pt-2 border-t border-blue-200 dark:border-blue-700">
