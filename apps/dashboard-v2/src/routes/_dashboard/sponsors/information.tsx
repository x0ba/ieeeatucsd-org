        ...
        <Card className="shadow-md hover:shadow-lg transition-shadow duration-200">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-base font-medium">{sponsorData?.sponsorOrganization || "Not specified"}</p>
            </div>
            <div>
        ...
        <Card className="shadow-md hover:shadow-lg transition-shadow duration-200">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Badge variant="outline" className={cn("px-4 py-2 text-sm font-semibold border", getTierColor(sponsorData?.sponsorTier))}>
                {sponsorData?.sponsorTier || "Not assigned"}
              </Badge>
            </div>
            {sponsorData?.autoAssignedSponsor && (
              <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-xl">
                <p className="text-xs text-blue-800">✓ Automatically assigned based on email domain</p>
              </div>
            )}
          </CardContent>
        </Card>
        ...
        {sponsorData?.sponsorTier && (
          <CardFooter className="bg-blue-50 border-t border-blue-200">
            <p className="text-sm text-blue-800 text-center w-full">
              <strong>Your current tier: {sponsorData.sponsorTier}</strong> - You have access to all benefits marked
              with ✓ or ➡️ in the {sponsorData.sponsorTier} column
            </p>
          </CardFooter>
        )}
      </Card>
